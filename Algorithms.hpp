...
public:
    ...
    static bool isContainsCycleUtil(Graph& g, size_t src, vector<Color>* colors, vector<int>* parents,vector<int>* path);
    static void printCycle(vector<int>& path, vector<int>& parents, int start) ;
